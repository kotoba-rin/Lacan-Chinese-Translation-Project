...
这里收录可独立阅读、来源可核验，并能返回具体研讨班译文语境的知识卡。本页以“先定位研讨班，再进入卡片，最后沿关联继续阅读”为主线；项目维护过程不再堆叠在索引中。

## 快速检索

1. **已知研讨班**：先看下方“按研讨班浏览”总表，再展开该研讨班的全部卡片。
2. **已知人物、作品或概念**：使用浏览器的 `Ctrl+F`／`⌘F` 搜索标题；进入卡片后，再查看 YAML 中的 `人物/…`、`作品/…`、`概念/…` 等标签。
3. **需要上下文**：卡片末尾 `## 关联` 中，知识卡链接用于继续主题阅读，译文分段链接用于返回拉康当时的具体论述。
4. **需要核对证据**：先看卡片的 `## 来源`；本地法语原文优先，外部原典、词典、学术出版物和机构资料用于补足背景。

标签的主要入口是：研讨班标签；`领域/…`；`人物/…`、`作品/…`、`期刊/…`、`机构/…`、`团体/…`；`概念/…`、`传统/…`、`体裁/…`；以及必要的 `语言/…`、`地区/…`、`时期/…`。每张卡只保留 3–5 个核心标签。

## 全库概览与关联审计

当前共收录 439 张知识卡；其中带 `研讨班I` 标签的有 18 张，带 `研讨班II` 标签的有 29 张，带 `研讨班III` 标签的有 9 张，带 `研讨班IV` 标签的有 20 张，带 `研讨班V` 标签的有 19 张，带 `研讨班VI` 标签的有 1 张，带 `研讨班VII` 标签的有 37 张，带 `研讨班VIII` 标签的有 119 张，带 `研讨班IX` 标签的有 8 张，带 `研讨班X` 标签的有 19 张，带 `研讨班XI` 标签的有 17 张，带 `研讨班XII` 标签的有 0 张，带 `研讨班XIII` 标签的有 16 张，带 `研讨班XIV` 标签的有 11 张，带 `研讨班XV` 标签的有 19 张，带 `研讨班XVI` 标签的有 22 张，带 `研讨班XVII` 标签的有 81 张，带 `研讨班XVIII` 标签的有 11 张，带 `研讨班XIX` 标签的有 27 张，带 `研讨班XIXb` 标签的有 112 张，带 `研讨班XX` 标签的有 19 张，带 `研讨班XXI` 标签的有 12 张，带 `研讨班XXII` 标签的有 15 张，带 `研讨班XXIII` 标签的有 8 张，带 `研讨班XXIV` 标签的有 16 张，带 `研讨班XXV` 标签的有 13 张，带 `研讨班XXVI` 标签的有 12 张，带 `研讨班XXVII` 标签的有 14 张。同一卡片可以关联多个研讨班，因此各标签数量不能直接相加。
