...
本表用于统一第十九研讨班译文。正文以“统一中文译名”为准；拉康新造词、同音双关及无法由单一汉译穷尽的词，首次出现时保留法文并加译注。

## 标题、逻辑与性化公式

| 外文 | 统一中文译名 | 备注 |
| --- | --- | --- |
| ... ou pire | ……或更糟 | *pire* 在标题中是副词；不译作名词性的“最糟者”。 |
| il n’y a pas de rapport sexuel | 性关系不存在 | *rapport* 保留“关系”义；不擅自补成“两性关系”。 |
| prosdiorisme | 量项 | 拉康借用希腊语来源的逻辑术语；与现代逻辑的 *quantificateur*“量词”区分。 |
| quantificateur | 量词 | 指 $\forall$、$\exists$ 等现代量词。 |
| variable apparente | 表观变项 | 依本研讨班原文用语；指在式中标出可由同一能指代入的空位。 |
| pas-tout / pas-toute | 非全 | 不等同于否定全称命题，也不改写成“并非一个也没有”。 |
| fonction phallique | 阳具函数 | 公式写作 $\Phi(x)$。 |
| forclusion | 拒斥 | 与 *discordance*“不协调”区分；沿用项目既有译名。 |
...
| 外文 | 统一中文译名 | 备注 |
| --- | --- | --- |
| l’Un | 一 | 名词化并具有概念地位时加引号或斜体。 |
| Yad’lun / il y a de l’Un | 有一 | *Yad’lun* 保留连写，以显出其口语声音与公式性。 |
| unien | 一者域 / 一者域的 | 拉康由 *Un* 临时造出的名词兼形容词；与 *unaire* 区分。 |
| unier | 一化 | 由 *unien* 进一步构造的动词，保留“使成一”的动态形式。 |
| trait unaire | 一元特征 | 沿用第十七研讨班术语；不与 *unien* 混同。 |
| monade / dyade / triade / tétrade | 单子 / 二元组 / 三元组 / 四元组 | 集合论与柏拉图语境中保持层级对应；话语结构中的 *tétrade* 依上下文译“四项式”。 |
| mêmeté | 同一性 | 第八课用来否定以“自身相同”奠定“一”的进路；首次保留法文。 |
| nade | 无元 | 呼应西班牙语 *nada*，又与 *monade* 押韵；首次保留法文并加译注。 |
...
| 外文 | 统一中文译名 | 备注 |
| --- | --- | --- |
| representamen | *representamen* | 保留皮尔士术语，不以“表象”或“代表项”覆盖其专门含义。 |
| interprétant | 解释项 | 第十二课明确说“解释项就是分析者”。 |
| objet | 对象 | 符号学三角形中的对象；依上下文同小对象 $a$ 区分。 |
| ground | 底层 | 指符号从某一观点同对象发生关系的地基；首次保留英文。 |
| potential | 潜能 | 皮尔士关于绝对 $0$ 的论述中使用。 |
