...
——也就是一方面随便哪一个，那么我们就完全处在那种可以被称为……（请你们在这个条件式中，辨认出某种东西，它正与我那《可能不是拟真的话语》产生回响）——是的，一旦把“每一个”替换为“任何一个”，我们就确实处在这样一种不确定性之中：在每一个“全体”之中，究竟是哪一个被选出，来回应“所有其他人”。
...
在上方标着否定符号的 $\Phi$ 的一侧，也就是说，正是在阳具功能不发生作用的意义上，性关系才有其可能性，因此我们在这里设定：为此至少存在一个 x $[\exists X \; \overline{\Phi X}]$。
...
当然，在实际运作的层级——也就是阳具功能的层级——则有我刚才提到的那种不协调：两边在这里并不处于同一位置。一边有一个建立在与阳具功能之必然关系上的全称；另一边因为女人是“非全体”，只有一种与阳具功能的偶然关系。
