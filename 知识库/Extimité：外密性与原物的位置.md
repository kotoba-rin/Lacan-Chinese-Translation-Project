...
这个位置同弗洛伊德的 *Ding* 读法相连。在 *Nebenmensch* 经验中，一部分属性可以通过比较、记忆和言语得到辨认，另一个恒定成分却作为陌异之物被隔离。拉康不是把 *das Ding* 当作藏在心灵深处、等待发现的实体，而是用它标示表象与所指网络不能吸收、却仍组织欲望绕行的中心空位。
