...
“理解”这里并不是作为分析家应该有的姿态。 如果能指没能拦住你，不就意味着你跳过了某个能指吗？
...
就性而言，人们只能认为性无处不在：自然、努斯（νοῦς [nouss]）、整个乱七八糟的东西，这一切都是性……而雌性秃鹫与风做爱。[注1] 我们知道，以一种确定的方式，性就在那里：在两个彼此不相像的小细胞中；早在人们知道有两种配子之前，精神分析家就已经以性之名相信有性关系（rapport sexuel）。
...
<!-- id: s19b-06-0159 -->
<!-- ids: s19b-06-0159 s19b-06-0160 s19b-06-0161 s19b-06-0162 s19b-06-0163 s19b-06-0164 s19b-06-0165 s19b-06-0166 s19b-06-0167 s19b-06-0168 s19b-06-0169 -->
...
另一方面，一边是「一切 x 都符合函数 Φx」（$\forall x\,\Phi(x)$），另一边是「非全」（$\overline{\forall x}\,\Phi(x)$）。这是一个新公式——「非全」，仅此而已，也就是右栏中的「并非所有 x 都可能满足所谓的阳具函数（fonction phallique）」；正是围绕着这个……正如我将在后续研讨班中尽力解释的，也就是说在别处……正是这个，也就是说在一系列裂口（béances）中——这些裂口存在于人们根据这些项——即这里、这里、这里、这里——而假定其功能的每一点上，各种裂口，并不总是相同的……正是这个才值得被标出，以便给出主体、性关系周围那种东西的身份。
...
在这个表述里，刻画无限集合的特征，严格说来就在于：它能够被设定为与它的某个真子集等价（等势）。
...
> 无限集合的一个定义性特征，就是它可以与其某个真子集等势（即存在一个一一对应）。
> 拉康举了伽利略很早就观察到的例子：所有的平方数（0, 1, 4, 9, 16, ...）和非负整数（0, 1, 2, 3, 4, ...）之间可以建立完全对应，因为每个非负整数 n 都有 n² 与之配对。并不存在某个巨大的平方数会大到“超出”非负整数范围。
...
![[texts/s19b-le-savoir-du-psychanalyste/original/assets/image30.png|7]]
...
它的意义在于：一旦用“幂集（parties）”这一概念替换为“划分/分割（partition）”这一概念，就有必要……同样地，既然我们已经承认：无限集合的“幂集”会是 $2^{\aleph_0}$，也就是最小的超限基数——由整数集合 ![[texts/s19b-le-savoir-du-psychanalyste/original/assets/image30.png|7]] 的基数所构成的那个……
...
$\aleph_0$（即 $\mathbb{N}$ 的基数）与 $2^{\aleph_0}$（即 $\mathbb{R}$ 的基数）之间？
...
从这一刻起，对那超限之集（ensemble transfini）的划分就导向如下结论：也就是说，如果在此我们把阿列夫零 $\aleph_0$ 等同于1，那么就“这个划分”而言——这看起来确实也完全可以接受——整数序列除了对“1”的反复迭代之外并无别的支撑：那个从空集里出来的1。

<!-- id: s19b-06-0291 -->
<!-- ids: s19b-06-0291 s19b-06-0292 s19b-06-0293 s19b-06-0294 s19b-06-0295 s19b-06-0296 s19b-06-0297 s19b-06-0298 s19b-06-0299 -->
...
![[texts/s19b-le-savoir-du-psychanalyste/original/assets/image32.jpeg|26]] ![[texts/s19b-le-savoir-du-psychanalyste/original/assets/image33.jpeg|97]] ![[texts/s19b-le-savoir-du-psychanalyste/original/assets/image34.jpeg|24]] ![[texts/s19b-le-savoir-du-psychanalyste/original/assets/image35.jpeg|78]]
...
<!-- id: s19b-06-0336 -->
<!-- ids: s19b-06-0336 s19b-06-0337 s19b-06-0338 s19b-06-0339 s19b-06-0340 s19b-06-0341 s19b-06-0342 s19b-06-0343 s19b-06-0344 s19b-06-0345 s19b-06-0346 s19b-06-0347 s19b-06-0348 -->
